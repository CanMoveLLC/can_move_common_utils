...
mixin _$CanMoveNotification {
  ...
  @JsonKey(ignore: true)
  $CanMoveNotificationCopyWith<CanMoveNotification> get copyWith =>
...
class _$_CanMoveNotification extends _CanMoveNotification {
  ...
  @override
  String toString() {
    return 'CanMoveNotification(uid: $uid, time: $time, userUid: $userUid, content: $content, imgUrl: $imgUrl, loadUid: $loadUid)';
  }
    ...
    return identical(this, other) ||
        (other is _CanMoveNotification &&
            ...
            (identical(other.loadUid, loadUid) ||
                const DeepCollectionEquality().equals(other.loadUid, loadUid)));
  }
...
abstract class _CanMoveNotification extends CanMoveNotification {
  const factory _CanMoveNotification(
      ...
      required String content,
      String? imgUrl,
      String? loadUid}) = _$_CanMoveNotification;
